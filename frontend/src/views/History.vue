...
const updates = ref([
  ...
  },
  {
    ...
    },
    {
       ...
       content: '支持游客发表评论，采用_identicon_生成唯一头像。增加基于 IP 的评论限流策略，防止刷屏。'
    },
  {
    id: '2026-04-29',
    version: 'v1.x',
  ...
  },
  {
    ...
    type: 'feature',
    releaseDate: '2026-05-01',
    content: '包含三路混合推荐引擎（内容推荐 40% + 协同过滤 40% + 热度 20%）。匿名用户显示综合热度推荐，登录用户基于行为个性化推荐。注册时支持兴趣标签选择，冷启动用户先基于兴趣标签推荐。包含用户行为追踪（浏览、点赞、收藏）、文章相似度矩阵定时更新、Redis 缓存预计算。'
  }
])
