...
function markdownItTocDoneRight_default(r, t) {
  ...
  r.renderer.rules.tocOpen = function(e2, r2) {
    ...
    return (function e3(r3) {
      ...
      if (0 === r3.c.length) return "";
      var u = "";
      return (0 === r3.l || c(r3.l)) && (u += "<" + (n(i2.listType) + l2) + ">"), r3.c.forEach(function(r4) {
        c(r4.l) ? u += "<li" + s2 + "><a" + o + ' href="#' + (function(e4) {
          for (var n2 = e4, r5 = i2.uniqueSlugStartIndex; Object.prototype.hasOwnProperty.call(a, n2); ) n2 = e4 + "-" + r5++;
          return a[n2] = true, n2;
    ...
    l = (function(e3) {
      for (var n2 = { l: 0, n: "", c: [] }, r2 = [n2], t2 = 0, l2 = e3.length; t2 < l2; t2++) {
        ...
        if ("heading_open" === i2.type) {
          ...
          if (a.l > r2[0].l) r2[0].c.push(a), r2.unshift(a);
          else if (a.l === r2[0].l) r2[1].c.push(a), r2[0] = a;
          else {
            for (; a.l <= r2[0].l; ) r2.shift();
